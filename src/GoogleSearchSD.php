...
/***
 * Searchdata.io Google Search SDK
 */
class GoogleSearchSD extends SearchDataSDK {
    /**
     * The constructor
     *
     * @return void
     ...
     * 
     * @param  string  $value  Defines where do you want the search to originate from. Please use LocationApiSD to obtain a location. 
     *
     * @return void
     */
